...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 z-50 w-full transition-all duration-300">
            {/* Top Ticker Bar */}
            <div className={`bg-[#000322] text-white text-[11px] md:text-sm font-medium transition-all duration-300 overflow-hidden ${scrolled ? 'max-h-0 opacity-0 py-0' : 'max-h-12 opacity-100 py-2.5'}`}>
