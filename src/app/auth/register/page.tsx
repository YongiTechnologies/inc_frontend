                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <div className="text-left">
                            ...
                            <div className="relative flex items-center">
                                ...
                                <input
                                    type="password"
                                    className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-transparent rounded-xl focus:outline-none focus:ring-2 focus:ring-[#039B81]/20 focus:bg-white focus:border-[#039B81]/30 transition-all text-gray-900"
                                    placeholder="••••••••"
